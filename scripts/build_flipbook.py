...
<div style="width:100%;max-width:700px;margin:24px auto 0;padding:0 12px;text-align:center;">
  <p style="font-family:'Bookman Old Style','Bookman',Georgia,serif;font-style:italic;font-size:1rem;color:#aaa;margin-bottom:14px;">Print copies of the Extra Cheese booklet are available for $10 + shipping at the link below.</p>
  <a href="https://www.lulu.com/shop/nahreally-and-nate-leblanc-and-thomas-mattera/extra-cheese/paperback/product-w4w96e7.html" target="_blank" style="display:inline-block;font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue',Arial,sans-serif;font-style:normal;font-size:0.8rem;font-weight:700;color:#111;background:#ffe033;padding:10px 28px;border-radius:4px;text-decoration:none;letter-spacing:1px;transition:background 0.15s;" onmouseover="this.style.background='#ffd000'" onmouseout="this.style.background='#ffe033'">ORDER A COPY</a>
