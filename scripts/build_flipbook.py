...
<style>
  * { box-sizing: border-box; margin: 0; padding: 0; touch-action: manipulation; }
  ...
  .social-pipe { display:inline; }
  .social-links { display:inline-flex; }
  @media (max-width: 600px) {
    .social-pipe { display:none; }
    .social-links { flex-direction:column; align-items:center; gap:8px; }
...
<div style="width:100%;max-width:700px;margin:24px auto 0;padding:0 12px;text-align:center;">
  ...
  <div style="margin-bottom:24px;">
    <div class="social-links" style="gap:12px;margin-top:9px;">
      ...
      <span class="social-pipe" style="color:#555;">|</span>
      <a href="https://nahreally.substack.com/" target="_blank" style="display:inline-flex;align-items:center;gap:6px;text-decoration:none;color:#888;font-family:-apple-system,BlinkMacSystemFont,'Helvetica Neue',Arial,sans-serif;font-size:0.75rem;letter-spacing:1px;transition:color 0.15s;" onmouseover="this.style.color='#eee'" onmouseout="this.style.color='#888'">
